...
const SCHEDULES = [
  ...
  // DISABLED (cost saving) { schedule: '0 23 * * 1-5',   path: '/api/cron-cognitive-synthesis',     name: 'cognitive-synthesis' },
  // DISABLED (cost saving) { schedule: '0 0 * * 2-6',    path: '/api/cron-personamail-loop',        name: 'personamail-loop' },
  ...
  // DISABLED (cost saving) { schedule: '0 5 * * 0',      path: '/api/cron-rule-promotion',          name: 'rule-promotion' },
  { schedule: '0 3 * * 0',      path: '/api/cron-contact-reenrich',        name: 'contact-reenrich' },
  // DISABLED (cost saving) { schedule: '0 2 * * *',      path: '/api/cron-self-awareness',          name: 'self-awareness' },
  // DISABLED (cost saving) { schedule: '0 6 * * 1-5',    path: '/api/cron-company-monitor',         name: 'company-monitor' },

  // Weekday business
  // DISABLED (cost saving) { schedule: '0 7 * * 1-5',    path: '/api/cron-segment-enroller',        name: 'seg-enroller' },
  ...
  // DISABLED (cost saving) { schedule: '0 12 * * 1-5',      path: '/api/cron-linkedin-social-listen', name: 'linkedin-social-listen' },
  // DISABLED (cost saving) { schedule: '0 9 * * 1-5',    path: '/api/cron-outreach-score',          name: 'outreach-score' },
  ...
  // DISABLED (cost saving) { schedule: '0 4 * * 0',      path: '/api/cron-profile-synthesis',       name: 'profile-synthesis' },
  // DISABLED (cost saving) { schedule: '0 4 * * 0,3',    path: '/api/cron-email-voice-learning',    name: 'email-voice' },
  // DISABLED (cost saving) { schedule: '0 5 * * *',      path: '/api/cron-relationship-intel',      name: 'relationship-intel' },
