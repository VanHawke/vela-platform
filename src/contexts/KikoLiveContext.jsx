    ...
    try {
      const [alertRes, alertCountRes, taskRes, fuRes, draftRes] = await Promise.all([
        ...
        supabase.from('kiko_alerts')
          ...
          .eq('dismissed', false)
          .in('type', ['email_reply', 'email_reply_manual', 'linkedin_reply', 'linkedin_connection_accepted', 'reply_from_prospect', 'follow_up_overdue', 'ooo_detected', 'proactive_recommendation']),
        supabase.from('tasks')
          .select('*')
