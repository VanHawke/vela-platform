          ...
          return (
            <div style={{ marginBottom: 8 }}>
              <button onClick={() => setExpandedSteps(isOpen ? null : i)} style={{
                ...
                fontSize: 12, color: 'rgba(124,92,252,0.55)', background: isOpen ? 'rgba(0,0,0,0.04)' : 'rgba(0,0,0,0.02)',
