...
STYLE: Say "intelligent age" not "AI generation". All financials in USD. No markdown. No lists.`,
              tools: [
                ...
                { type: 'function', name: 'navigate_page', description: 'Navigate platform to a page.', parameters: { type: 'object', properties: { page: { type: 'string', enum: ['home','pipeline','contacts','command-centre','calendar','tasks','partnership-matrix','organisations','news','documents'] } }, required: ['page'] } },
