  ...
  if (!logoDomain || failed) {
    return (
      <div style={{
        ...
        background: 'rgba(139,108,246,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center',
        fontSize: size * 0.4, fontWeight: 600, color: 'rgba(139,108,246,0.5)', ...style,
      }}>{initial}</div>
    )
  }
