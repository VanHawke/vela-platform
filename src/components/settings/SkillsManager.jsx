  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <button onClick={startNew} style={{ padding: '6px 16px', borderRadius: 50, background: T.accentSoft, border: `1px solid ${T.accentBorder}`, color: 'rgba(0,0,0,0.55)', fontSize: 13, cursor: 'pointer', fontFamily: T.font, fontWeight: 400 }}>+ New Skill</button>
      </div>
