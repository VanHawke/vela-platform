...
const T = {
  bg: '#000000', surface: 'rgba(0,0,0,0.03)', border: 'rgba(0,0,0,0.08)',
  borderHover: 'rgba(0,0,0,0.08)', text: '#0A0A0A',
  textSecondary: '#6B6B6B', textTertiary: '#A0A0A0',
  accent: '#C0C0C0', font: "'DM Sans', sans-serif",
}
    ...
    <div style={{ fontFamily: T.font }}>
      ...
      {showCrop && rawUrl && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 300, background: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(24px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ background: T.surface, borderRadius: 18, padding: 24, maxWidth: 520, width: '90%', boxShadow: '0 24px 80px #C0C0C0' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8, marginTop: 16 }}>
              ...
              <button onClick={saveCrop} disabled={uploading} style={{ height: 36, padding: '0 20px', borderRadius: 50, border: 'none', background: T.accent, color: '#FFFFFF', fontSize: 14, fontWeight: 500, cursor: 'pointer', fontFamily: T.font, display: 'flex', alignItems: 'center', gap: 6 }}>
      ...
      >
        ...
        {uploading && (
          <div style={{ position: 'absolute', inset: 0, background: '#0A0A0A', borderRadius: 50, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
