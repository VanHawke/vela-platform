    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 10, color: 'rgba(238,238,238,0.7)', lineHeight: 1.5 }}>
        ...
        <button onClick={onApply} disabled={running || loading} style={{
          ...
          background: running ? 'rgba(167,139,250,0.10)' : T.accent,
          border: 'none', color: running ? T.accent : '#0A0A0C',
        ...
        {results && (
          <div style={{
            padding: 12, borderRadius: 8,
            background: 'rgba(45,212,191,0.06)', border: '1px solid rgba(45,212,191,0.30)',
          }}>
