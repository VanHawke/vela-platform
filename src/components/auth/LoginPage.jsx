...
export default function LoginPage() {
  ...
  const glassInput = {
    ...
    padding: '0 18px', fontSize: 14, color: '#f4f4f6', outline: 'none',
    fontFamily: T.font, fontWeight: 300, transition: 'all 0.2s',
  }
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100vw', height: '100vh', background: '#1c1c24', fontFamily: T.font, position: 'relative', overflow: 'hidden' }}>
      <AuroraCanvas />

      {/* Ambient glow behind waveform */}
      <div style={{ position: 'absolute', width: 500, height: 500, borderRadius: '50%', background: 'radial-gradient(circle, rgba(124,92,252,0.06) 0%, transparent 70%)', top: '50%', left: '50%', transform: 'translate(-50%, -65%)', zIndex: 1, pointerEvents: 'none' }} />
      ...
      <div style={{ width: '100%', maxWidth: 380, textAlign: 'center', position: 'relative', zIndex: 5, padding: '0 24px' }}>
        ...
        <div style={fade(0.6)}>
          <button onClick={googleLogin} disabled={gLoading} style={{
            ...
            fontSize: 14, fontWeight: 400, color: '#f4f4f6', cursor: 'pointer', fontFamily: T.font,
            transition: 'all 0.3s',
            boxShadow: '0 4px 24px rgba(0,0,0,0.3)',
          }}
            onMouseEnter={e => { e.currentTarget.style.background = 'rgba(124,92,252,0.10)'; e.currentTarget.style.borderColor = 'rgba(124,92,252,0.20)'; e.currentTarget.style.transform = 'translateY(-1px)' }}
            onMouseLeave={e => { e.currentTarget.style.background = 'rgba(124,92,252,0.05)'; e.currentTarget.style.borderColor = 'rgba(124,92,252,0.12)'; e.currentTarget.style.transform = 'translateY(0)' }}
        ...
        <div style={{ marginTop: 16, ...fade(0.7) }}>
          <button onClick={() => setShowEmail(!showEmail)} style={{
            ...
            onMouseEnter={e => e.currentTarget.style.color = '#9b9ba3'}
            onMouseLeave={e => e.currentTarget.style.color = 'rgba(124,92,252,0.20)'}
          >
        ...
        <div style={{ overflow: 'hidden', maxHeight: showEmail ? 260 : 0, opacity: showEmail ? 1 : 0, transition: 'max-height 0.4s ease, opacity 0.3s ease', marginTop: showEmail ? 12 : 0 }}>
          <form onSubmit={emailLogin}>
            <input type="email" placeholder="Email" value={email} onChange={e => setEmail(e.target.value)}
              ...
              onFocus={e => e.target.style.borderColor = 'rgba(124,92,252,0.30)'}
            ...
            <button type="submit" disabled={loading} style={{
              ...
              background: 'linear-gradient(135deg, rgba(124,92,252,0.55), rgba(57,48,40,0.55))',
              color: '#f4f4f6', border: 'none',
