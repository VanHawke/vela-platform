        ...
        {activeChannelData && (
          <div style={{ padding: '10px 20px', borderBottom: `1px solid ${C.border}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              ...
              }} style={{ width: 32, height: 32, borderRadius: 4, background: 'none', border: 'none', color: C.sub, cursor: 'pointer', display: 'grid', placeItems: 'center' }}><Icon name="phone" size={14} /></button>
              <button onClick={() => setSearchOpen(!searchOpen)} style={{ width: 32, height: 32, borderRadius: 4, background: 'none', border: 'none', color: C.sub, cursor: 'pointer', display: 'grid', placeItems: 'center' }}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg></button>
              <button onClick={() => setShowFilesPanel(!showFilesPanel)} style={{ width: 32, height: 32, borderRadius: 4, background: 'none', border: 'none', color: C.sub, cursor: 'pointer', display: 'grid', placeItems: 'center' }}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg></button>
            </div>
          </div>
        )}
