...
const T = {
  bg: '#000000', surface: 'rgba(0,0,0,0.03)', surfaceHover: 'rgba(0,0,0,0.08)',
  border: 'rgba(0,0,0,0.08)', borderHover: 'rgba(0,0,0,0.08)',
  text: '#0A0A0A', textSecondary: '#6B6B6B', textTertiary: '#A0A0A0',
  accent: '#C0C0C0', accentSoft: 'rgba(0,0,0,0.03)',
    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: 'transparent', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '24px 32px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <button onClick={() => setCreating(true)} style={{
          ...
          color: '#0A0A0A', border: 'none', fontSize: 14, fontWeight: 500,
