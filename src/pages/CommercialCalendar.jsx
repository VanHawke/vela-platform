...
// F1 2026 — 22 rounds (Bahrain + Saudi Arabia cancelled due to Middle East conflict)
// Sprint venues: China, Miami, Canada, British, Dutch, Singapore
// Saturday races: Azerbaijan (Sep 26), Las Vegas (Nov 21)
// Source: formula1.com official calendar, verified March 2026
const F1_2026 = [
  { round: 1,  name: 'Australian GP',            city: 'Melbourne',   date: '2026-03-06', end: '2026-03-08' },
  { round: 2,  name: 'Chinese GP',               city: 'Shanghai',    date: '2026-03-13', end: '2026-03-15', sprint: true },
  { round: 3,  name: 'Japanese GP',              city: 'Suzuka',      date: '2026-03-27', end: '2026-03-29' },
  { round: 4,  name: 'Miami GP',                 city: 'Miami',       date: '2026-05-01', end: '2026-05-03', sprint: true },
  { round: 5,  name: 'Canadian GP',              city: 'Montréal',    date: '2026-05-22', end: '2026-05-24', sprint: true },
  { round: 6,  name: 'Monaco GP',                city: 'Monte Carlo', date: '2026-06-05', end: '2026-06-07' },
  { round: 7,  name: 'Barcelona-Catalunya GP',   city: 'Barcelona',   date: '2026-06-12', end: '2026-06-14' },
  { round: 8,  name: 'Austrian GP',              city: 'Spielberg',   date: '2026-06-26', end: '2026-06-28' },
  { round: 9,  name: 'British GP',               city: 'Silverstone', date: '2026-07-03', end: '2026-07-05', sprint: true },
  { round: 10, name: 'Belgian GP',               city: 'Spa',         date: '2026-07-17', end: '2026-07-19' },
  { round: 11, name: 'Hungarian GP',             city: 'Budapest',    date: '2026-07-24', end: '2026-07-26' },
  { round: 12, name: 'Dutch GP',                 city: 'Zandvoort',   date: '2026-08-21', end: '2026-08-23', sprint: true },
  { round: 13, name: 'Italian GP',               city: 'Monza',       date: '2026-09-04', end: '2026-09-06' },
  { round: 14, name: 'Madrid GP',                city: 'Madrid',      date: '2026-09-11', end: '2026-09-13' },
  { round: 15, name: 'Azerbaijan GP',            city: 'Baku',        date: '2026-09-25', end: '2026-09-26', saturday: true },
  { round: 16, name: 'Singapore GP',             city: 'Singapore',   date: '2026-10-09', end: '2026-10-11', sprint: true },
  { round: 17, name: 'United States GP',         city: 'Austin',      date: '2026-10-23', end: '2026-10-25' },
  { round: 18, name: 'Mexico City GP',           city: 'Mexico City', date: '2026-10-30', end: '2026-11-01' },
  { round: 19, name: 'São Paulo GP',             city: 'São Paulo',   date: '2026-11-06', end: '2026-11-08', sprint: true },
  { round: 20, name: 'Las Vegas GP',             city: 'Las Vegas',   date: '2026-11-19', end: '2026-11-21', saturday: true },
  { round: 21, name: 'Qatar GP',                 city: 'Lusail',      date: '2026-11-27', end: '2026-11-29' },
  { round: 22, name: 'Abu Dhabi GP',             city: 'Abu Dhabi',   date: '2026-12-04', end: '2026-12-06' },
]

// Formula E Season 12 — 17 rounds across 11 cities
// Source: fiaformulae.com + therace.com, verified March 2026
const FE_S12 = [
