...
const DOMAINS = [
  ...
  // ── Lifestyle & Concierge Intelligence ──
  { id: 'miami-lifestyle', topic: 'Miami luxury lifestyle and high-end scene 2026: best fine dining restaurants (Mila, Komodo, Papi Steak, Zuma, Gekko, Cecconi\'s, Casadonna), hottest nightclubs and lounges (LIV, E11EVEN, Do Not Sit On The Furniture, Floyd, Basement, Story), exclusive members clubs, rooftop bars, art scene (Wynwood, Design District, Pérez Art Museum), upcoming events this month (Art Basel residual events, Miami Music Week, Ultra, boat shows, polo), hotel recommendations (Faena, Four Seasons Surf Club, Edition, Setai, 1 Hotel South Beach), Miami social calendar from Ocean Drive Magazine, Miami New Times, Haute Living Miami, Tatler, local Instagram tastemakers and curators. Focus on: where high-net-worth individuals and sports/entertainment industry executives spend time, private members\' venues, invitation-only events, best tables, dress codes, valet situations' },
  { id: 'luxury-lifestyle-global', topic: 'Global luxury lifestyle intelligence 2026: Michelin-starred restaurants worldwide, Forbes Travel Guide 5-star properties, luxury hotel openings (Aman, Rosewood, Six Senses, Mandarin Oriental), private members clubs (Soho House, Core, Oswald\'s, Zero Bond, Casa Cipriani), high society events calendar (Royal Ascot, Monaco GP parties, Cannes, Art Basel, Frieze), luxury concierge trends from Quintessentially, Luxury Travel Advisor, Condé Nast Traveller, Tatler, Monocle, Wallpaper*. Wine and spirits trends, private aviation, yacht charter market. Focus on: lifestyle intel that a CEO traveling between London, Miami, Monaco, and Dubai would value' },
];
