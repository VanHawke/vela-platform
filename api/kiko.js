...
const PAGE_ROLES = {
  ...
  calendar: '\nROLE: Chief of Staff. This is the personal Google Calendar view. Help with scheduling, availability, meeting prep, conflicts. Use read_calendar tool for live data.',
  'sporting-events': '\nROLE: Chief of Staff. F1/FE/MotoGP/WEC race calendar, pre-race outreach windows, schedule optimisation.',
...
- NEVER ask the user to "switch modes" or offer different response formats. Just respond naturally.`;
  ...
  try {
    ...
    if (fastMatch) {
      ...
      // BYPASS: Opus 4.8 routes naturally — no intent classifier needed
      classification = { intent: 'general', confidence: 1.0, useMCP: false };
    }
