...
export const TOOL_DEFINITIONS = [
  ...
  {
    name: 'ask_data_agent',
    description: 'CRM reads + analytics. Use for: searching contacts/companies/deals, entity details, pipeline stats, stale contacts, email analytics, outreach intelligence, news, partnership matrix, activity feed, deal history, document search, past conversations, learning log, warm path introductions, win/loss analysis, refresh partnerships.',
    input_schema: { type: 'object', properties: {
      operation: { type: 'string', enum: ['search_contacts', 'search_companies', 'search_deals', 'entity_detail', 'alerts', 'email_analytics', 'outreach_intelligence', 'outreach_timing', 'stale_contacts', 'news', 'partnership_matrix', 'pipeline_notifications', 'deal_history', 'activity_feed', 'search_documents', 'past_conversations', 'recent_conversations', 'learning_search', 'learning_save', 'skills', 'bookmark', 'warm_path', 'win_loss', 'thread_history', 'deal_prediction', 'company_intel', 'refresh_partnerships'], description: 'Which data operation to run. company_intel: get enriched company intelligence (funding, leadership, competitors, sponsorship readiness). warm_path: find connections to a target company. win_loss: analyse deal outcomes and patterns. thread_history: cross-session discussion history for an entity. deal_prediction: score all active deals by closure probability. refresh_partnerships: web-search and update partnership matrix for a specific F1 team (pass team name in params.team).' },
