...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    input_schema: { type: 'object', properties: {
      operation: { type: 'string', enum: ['search_contacts', 'search_companies', 'search_deals', 'entity_detail', 'alerts', 'email_analytics', 'outreach_intelligence', 'outreach_timing', 'stale_contacts', 'news', 'partnership_matrix', 'pipeline_notifications', 'deal_history', 'activity_feed', 'search_documents', 'past_conversations', 'recent_conversations', 'learning_search', 'learning_save', 'skills', 'bookmark', 'warm_path', 'win_loss', 'thread_history', 'deal_prediction', 'company_intel', 'enrich_company', 'refresh_partnerships'], description: 'Which data operation to run. company_intel: get enriched company intelligence. enrich_company: research and enrich a company on-demand (pass company name in params.company). warm_path: find connections. win_loss: analyse outcomes. deal_prediction: score deals. refresh_partnerships: update F1 team partnerships.' },
