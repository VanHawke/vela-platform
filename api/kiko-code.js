...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (action === 'ai') {
      ...
      const systemPrompt = `You are Kiko in developer mode, working on the Kiko platform codebase.
...
Keep files under 400 lines.`;
    ...
    console.error('[KikoCode] Error:', err.message);
